...
QT_MOC_LITERAL(1, 6, 17), // "userIdRankChanged"
QT_MOC_LITERAL(2, 24, 0), // ""
QT_MOC_LITERAL(3, 25, 10) // "userIdRank"

    },
    "State\0userIdRankChanged\0\0userIdRank"
};
...
static const uint qt_meta_data_State[] = {
 ...
 // properties: name, type, flags
       3, QMetaType::QVariantList, 0x00495903,
...
void State::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->userIdRankChanged(); break;
        default: ;
        }
        ...
        {
            using _t = void (State::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&State::userIdRankChanged)) {
                *result = 0;
                return;
            }
        }
        ...
        void *_v = _a[0];
        switch (_id) {
        case 0: *reinterpret_cast< QVariantList*>(_v) = _t->userIdRank(); break;
        default: break;
        }
        ...
        void *_v = _a[0];
        switch (_id) {
        case 0: _t->setUserIdRank(*reinterpret_cast< QVariantList*>(_v)); break;
        default: break;
        }
